...
- **1.3.3+32:**
	...
	- Se regeneraron los íconos nativos desde el nuevo logo.
- **1.3.2+25:**
...
- El sonido usa el tono de alarma del sistema vía `flutter_ringtone_player` (se repite hasta detenerlo) y no requiere assets.
